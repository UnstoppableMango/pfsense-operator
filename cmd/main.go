...
import (
	...
	"github.com/unstoppablemango/pfsense-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(pfsensev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "13f067ef.unmango.dev",

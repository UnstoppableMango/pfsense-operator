...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^github.com/pulumi/pulumi-terraform-provider/sdks/go/libvirt/libvirt(/v\\d+)?")
...
func PkgGetPackageRef(ctx *pulumi.Context) (string, error) {
	if packageRef == nil {
		...
		parameter, err := base64.StdEncoding.DecodeString("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2RtYWN2aWNhci9saWJ2aXJ0IiwidmVyc2lvbiI6IjAuOC4zIn19")
		if err != nil {
			return "", err
		}

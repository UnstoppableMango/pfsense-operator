...
type DomainGraphics struct {
	...
	Type          *string  `pulumi:"type"`
	Websocket     *float64 `pulumi:"websocket"`
}
...
type DomainGraphicsArgs struct {
	...
	Websocket     pulumi.Float64PtrInput `pulumi:"websocket"`
}
...
func (o DomainGraphicsOutput) Websocket() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v DomainGraphics) *float64 { return v.Websocket }).(pulumi.Float64PtrOutput)
}
...
func (o DomainGraphicsPtrOutput) Websocket() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *DomainGraphics) *float64 {
		if v == nil {
			return nil
		}
		return v.Websocket
...
func (o DomainNetworkInterfaceOutput) Private() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DomainNetworkInterface) *string { return v.Private }).(pulumi.StringPtrOutput)
}
...
type GetNodeDeviceInfoCapabilityArgs struct {
	...
	IommuGroup       GetNodeDeviceInfoCapabilityIommuGroupPtrInput `pulumi:"iommuGroup"`
...
func (o GetNodeDeviceInfoCapabilityOutput) IommuGroup() GetNodeDeviceInfoCapabilityIommuGroupPtrOutput {
	return o.ApplyT(func(v GetNodeDeviceInfoCapability) *GetNodeDeviceInfoCapabilityIommuGroup { return v.IommuGroup }).(GetNodeDeviceInfoCapabilityIommuGroupPtrOutput)
}
